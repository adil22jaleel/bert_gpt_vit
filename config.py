...
def bert_config():
    ...
    config = {"device": device,
            ...
            "n_vocab": n_vocab,
            "dropout": dropout,
            "training_path": "/content/bert_gpt_vit/data/bert/training.txt",
            "vocab_path": "/content/bert_gpt_vit/data/bert/vocab.txt"
...
def gpt_config():
    ...
    config = {"BATCH_SIZE": 32,  # how many independent sequences will we process in parallel?
                ...
                "LEARNING_RATE": 3e-4,
                "DEVICE": device,
                "dataset_path": "/content/bert_gpt_vit/data/gpt/english.txt",
                "NUM_HEAD": num_head,
                "NUM_EMBED": num_embed,
                "NUM_LAYER": 6,
                "DROPOUT": 0.2}
...
def vit_config():
    device = "cuda" if torch.cuda.is_available() else "cpu"
    image_path = "/content/bert_gpt_vit/data/vit"
